...
export const BIOMES = [
  {
    ...
    // intendantBody: which avatar the Intendant wears in this biome. Same
    // data-driven rule as intendantShield — NEVER a `biome.id === 'x'` branch in
    // the sim/renderer. Bodies: 'robe' (default) | 'worker' | 'scout' | 'mascot'.
    intendantBody: 'robe',
    roughness: 1,
  ...
  },
  {
    ...
    intendantShield: 'egide',
    intendantBody: 'mascot',   // Orage : la mascotte (boule) plutôt que la robe
    roughness: 1.1,
    heightVariance: 80,
