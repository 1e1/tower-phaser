...
//   speedFactor : muzzle-velocity multiplier — a fixed-energy cannon launches a
//                 heavier ball slower (shorter reach at equal power) and a lighter
//                 one faster/flatter. Pairs with windFactor to give each shell a
//                 physical "weight": heavy = slow + wind-proof, light = fast + drifty.
...
export const SHELLS = [
  {
    id: 'normal', name: 'Normal', windFactor: 1.0, speedFactor: 1.0, craterMul: 1.0, count: 1, spread: 0, dmg: 1, tint: 0xffe066,
    svg: '<circle cx="12" cy="12" r="6"/>',
  },
  {
    id: 'heavy', name: 'Heavy', windFactor: 0.45, speedFactor: 0.9, craterMul: 1.5, count: 1, spread: 0, dmg: 2, tint: 0xb0b6c2,
    svg: '<circle cx="12" cy="10.5" r="6"/><rect x="4.5" y="18" width="15" height="3.2" rx="1.6"/>',
  },
  {
    id: 'light', name: 'Light', windFactor: 1.85, speedFactor: 1.12, craterMul: 0.8, count: 1, spread: 0, dmg: 1, tint: 0xbadff0,
  ...
  {
    id: 'salvo', name: 'Salvo', windFactor: 1.1, speedFactor: 0.95, craterMul: 0.65, count: 3, spread: 6, dmg: 0.5, tint: 0xffb86b,
    svg: '<circle cx="6.5" cy="15.5" r="3.4"/><circle cx="17.5" cy="15.5" r="3.4"/><circle cx="12" cy="6.5" r="3.4"/>',
  },
  {
    id: 'explosive', name: 'Explosive', windFactor: 1.0, speedFactor: 0.92, craterMul: 2.1, count: 1, spread: 0, dmg: 1.5, tint: 0xff5e5e,
